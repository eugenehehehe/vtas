...
import icon2 from '../image/240.png';
        ...
        <section className="custom bg">
            ...
            <div className="sectione">  
                ...
                <div className="stepse">
                    <div className='stepe'>
                        <img src={icon1} alt="Comprehensive Planning and Scoping" className="icon left-icon" />
                        <div className="text1">
                ...
                {/* <img src={vector2} alt="vector2" className="vectorE" /> */}

                <div className="stepe">
                    <img src={icon3} alt="Tailored Solution Design and Development" className="icon left-icon" />
                    <div className="text1">
                        <h2>Tailored Solution
                            <br/>Design and Development</h2>
                ...
                {/* <div className="stepe">
                    ...
                    <img src={icon4} alt="Rigorous Testing & Validation" className="icon right-icon" />
                </div> */}
                <div className="stepe">
                    <div className="text2">
                        <h2>Rigorous Testing and Validation</h2>
                        <p>To ensure the highest quality, we conduct extensive testing, including unit tests, integration tests, and user acceptance tests. This thorough process guarantees that the solution works seamlessly in your environment before it goes live​​.</p>
                    </div>
                    <img src={icon4} alt="Rigorous Testing & Validation" className="icon right-icon" />
                </div>
                ...
                <div className="stepe">
                    <img src={icon5} alt="Seamless Deployment and Ongoing Support" className="icon left-icon" />
                    <div className="text1">
