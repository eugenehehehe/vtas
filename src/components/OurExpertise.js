...
//     setActiveSlide(index); // Set the clicked card as the active slide
//     sliderRef.current.slickGoTo(index); // Move the slider to the clicked card
//   };
...
//         <Slider {...settings} ref={sliderRef} slickGoTo={activeSlide}>
//           {cards.map((card, index) => {
//             const isActive = index === activeSlide;
//             const isLeft = index === (activeSlide - 1) || (activeSlide === 0 && index === cards.length - 1);
